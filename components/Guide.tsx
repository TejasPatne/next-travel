  ...
  return (
    <section className="flexCenter flex-col">
        <div className="padding-container max-container w-full pb-24">
            ...
            <p className="uppercase regular-18 -t-1 mb-3 text-green-50">We are here for you</p>
            <div className="flex flex-wrap justify-between items-center gap-5 lg:gap-10">
                <h2 className="capitalize bold-40 lg:bold-50 xl:max-w-[390px]">Guide you to the easy path</h2>
            ...
            <div className="absolute flex bg-white py-8 pl-5 pr-7 gap-3 rounded-3xl shadow-md md:left-[5%] lg:top-20">
                ...
                <div className="flexBetween flex-col">
                    <div className="flex flex-col w-full">
                        ...
                        <p className="bold-20 mt-2">Table Land, Panchgani</p>
                    </div>

                    <div className="flex flex-col w-full">
                        <p className="regular-16 text-gray-20">Source</p>
                        <h4 className="bold-20 mt-2 whitespace-nowrap">Krushna river, Wai</h4>
                    </div>
                </div>
            </div>
        </div>
